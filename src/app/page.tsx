      ...
      <header className="fixed top-0 w-full bg-slate-950/80 backdrop-blur-xl border-b border-white/5 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="https://gtm.sbsnexus.de" className="text-sm text-amber-400 hover:text-amber-300 transition font-medium">GTM Hub</a>          </nav>
        ...
        {mobileMenu && (
          <div className="md:hidden bg-slate-950/95 backdrop-blur-xl border-t border-white/5 px-6 py-6 space-y-4">
            ...
            <a href="https://gtm.sbsnexus.de" className="block text-amber-400 hover:text-amber-300 font-medium">GTM Hub</a>          </div>
        )}
      </header>
